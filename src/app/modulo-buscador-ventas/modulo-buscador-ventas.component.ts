      ...
      .subscribe(
        ...
        let dtpag ;
          ...
          data.forEach((element) => {
            ...
            const tmpItem: any = {
              ClienteNombre:
                element.venta.cliente.nombres +
                " " +
                element.venta.cliente.apellidos,
              ...
              estadoCivilConyuge:
                element.venta.cliente.estadoCivilConyuge.nombre,
              ...
              // Datos de inmuebles
              tipoInmueble:
                element.listVentaInmueble[0].inmueble.tipoInmueble.nombre,
