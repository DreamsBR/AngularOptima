...
export class ReportesService {
  ...
  getConsolidadoGerencia(idGerencia: number, idPeriodo: number): Observable<any> {
    return this.http.get(this.urlEndPoint + '/consolidadogerencia/' + idGerencia + '/' + idPeriodo).pipe()
  }

  getConsolidadoProyecto(idGerencia: number, idPeriodo: number): Observable<any> {
    return this.http.get(this.urlEndPoint + '/consolidadoproyecto/' + idGerencia + '/' + idPeriodo).pipe()
  }
